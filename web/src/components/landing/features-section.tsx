...
export default function FeaturesSection() {
  ...
  return (
    <section ref={sectionRef} className="dark relative overflow-hidden bg-background py-32 text-foreground">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#424241] to-transparent" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative p-8 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:border-[#ffffff] transition-all duration-500 hover:bg-white/[0.04]"
                style={{
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <Icon className="w-7 h-7" style={{ color: "#201f1f" }} />
                  </div>
