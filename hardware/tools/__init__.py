...
def _get_tool_registry() -> LazyToolRegistry:
    ...
    if _tool_registry is None:
        ...
        _tool_registry.register_factory('SyncTool', lambda: _import_and_create('sync_tool', 'SyncTool'))
        _tool_registry.register_factory('SendBlueprintTool', lambda: _import_and_create('send_blueprint_tool', 'SendBlueprintTool'))
        _tool_registry.register_factory('UpdateBlueprintTool', lambda: _import_and_create('update_blueprint_tool', 'UpdateBlueprintTool'))
        _tool_registry.register_factory('SyncConfigTool', lambda: _import_and_create('sync_config_tool', 'SyncConfigTool'))
        _tool_registry.register_factory('SyncQueueTool', lambda: _import_and_create('sync_queue_tool', 'SyncQueueTool'))
        _tool_registry.register_factory('SyncStatusTool', lambda: _import_and_create('sync_status_tool', 'SyncStatusTool'))
        _tool_registry.register_factory('ResolveConflictTool', lambda: _import_and_create('resolve_conflict_tool', 'ResolveConflictTool'))
        _tool_registry.register_factory('ExecuteCodeTool', lambda: _import_and_create('execute_code_tool', 'ExecuteCodeTool'))
        _tool_registry.register_factory('WebSearchTool', lambda: _import_and_create('web_search_tool', 'WebSearchTool'))
        _tool_registry.register_factory('FetchWebpageTool', lambda: _import_and_create('web_search_tool', 'FetchWebpageTool'))
        _tool_registry.register_factory('SummarizeTool', lambda: _import_and_create('summarize_tool', 'SummarizeTool'))
        _tool_registry.register_factory('ExtractKeyPointsTool', lambda: _import_and_create('summarize_tool', 'ExtractKeyPointsTool'))
        _tool_registry.register_factory('ShellCommandTool', lambda: _import_and_create('shell_tool', 'ShellCommandTool'))
        _tool_registry.register_factory('ListDirectoryTool', lambda: _import_and_create('shell_tool', 'ListDirectoryTool'))
        _tool_registry.register_factory('RememberTool', lambda: _import_and_create('memory_tools', 'RememberTool'))
        _tool_registry.register_factory('RecallTool', lambda: _import_and_create('memory_tools', 'RecallTool'))
        _tool_registry.register_factory('ForgetTool', lambda: _import_and_create('memory_tools', 'ForgetTool'))
        _tool_registry.register_factory('MemoryStatsTool', lambda: _import_and_create('memory_tools', 'MemoryStatsTool'))
